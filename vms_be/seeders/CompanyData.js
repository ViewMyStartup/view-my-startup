...
const companyData = [
  {
    name: "에듀넥스트",
    logoUrl: `https://view-my-startup.onrender.com/images/company_logo_${faker.number.int({ min: 2, max: 35 })}.png`,
    description:
  ...
  {
    name: "코드잇",
    logoUrl: `https://view-my-startup.onrender.com/images/company_logo_1.png`,
    description:
