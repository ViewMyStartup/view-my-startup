...
const companyData = [
  {
    name: "에듀넥스트",
    logoUrl: `https://view-my-startup.onrender.com/images/company_logo_${faker.number.int({ min: 1, max: 33 })}.svg`,
    description:
  ...
  },
  {
    ...
    logoUrl: `https://view-my-startup.onrender.com/images/company_logo_${faker.number.int({ min: 1, max: 33 })}.svg`,
    description:
      "에너지솔루션솔루션은 태양광 및 풍력 에너지 시스템을 통해 친환경 에너지 공급을 혁신하는 스타트업입니다.\n\n" +
      "우리는 재생 가능 에너지원의 효율성을 극대화하여 탄소 배출을 줄이고, 지속 가능한 에너지 공급망을 구축하는 데 중점을 두고 있습니다.\n\n" +
      "에너지솔루션솔루션은 환경 보호와 에너지 자급률 향상에 기여하고 있습니다.",
    category: "에너지솔루션",
    totalInvestment: faker.number.int({ min: 1, max: 100 }) * 10000000,
    virtualInvestment: 0,
    revenue: faker.number.int({ min: 1, max: 100 }) * 10000000,
