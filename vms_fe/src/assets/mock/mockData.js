...
const mockupData = [
  ...
  },
  {
    name: "에듀브릭",
    description:
      "에듀브릭은 학습 자료와 교구를 제작하여 혁신적인 교육 솔루션을 제공하는 스타트업입니다.\n\n" +
      "우리의 목표는 학생들이 실질적인 학습 성과를 얻을 수 있도록 돕는 것입니다. 이를 위해 에듀브릭은 다양한 학습 자원을 개발하고, 최신 교육 트렌드를 반영한 교구와 자료를 제공하여 학습의 효과를 극대화합니다.\n\n" +
      "또한, 실험적인 교육 방법과 기술을 도입하여 학습자들이 더 나은 이해와 실력을 갖출 수 있도록 지원하며, 교육 현장에서의 실제 적용 사례를 통해 교육의 질을 향상시키고 있습니다.",
    category: "에듀테크",
  ...
  },
  {
    ...
    description:
      "러닝큐브는 게이미피케이션을 기반으로 한 온라인 학습 플랫폼을 제공하여 학습의 재미와 효율성을 동시에 추구합니다.\n\n" +
      "우리는 게임 요소를 학습에 도입하여 학습자의 참여도를 높이고, 학습 목표 달성을 위한 동기를 부여합니다. 러닝큐브는 다양한 교육 콘텐츠와 미션을 통해 학습자들에게 흥미롭고 도전적인 학습 경험을 제공합니다.\n\n" +
      "또한, 학습자의 진행 상황을 실시간으로 모니터링하고, 성과를 분석하여 맞춤형 피드백을 제공함으로써 학습의 질을 높이고 있습니다.",
    category: "에듀테크",
    total_investment: 9500000,
    revenue: 140000000,
    employees: 30,
